 ...
 * Slug: template-parts/content/posts/post-1
 * Categories: posts, slide-1
 * Description: Template for all posts shown on the first Slide
 */
?>
...
<article class="card">
    ...
    <div class="card_details">
        ...
        <a class="card_details_readme" href="<?php echo $card_link; ?>">> READ</a>
    </div>
</article>